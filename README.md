...
FlowTask đảm bảo người dùng luôn nắm bắt được tiến độ dự án thông qua hai kênh:
     + **Thông báo qua App:** Cập nhật tức thì các tương tác như bình luận (comment) mới hoặc thay đổi trạng thái công việc.
     + **Thông báo qua Email:** Tự động gửi thư chi tiết cho các sự kiện quan trọng:
         - **Giao việc:** Thông tin task vừa được phân công.
         - **Thành viên mới:** Xác nhận khi có người tham gia project.
         - **Cảnh báo Deadline:** Nhắc nhở tự động khi task còn dưới 24 giờ.
         - **Quá hạn:** Cảnh báo ngay lập tức khi task chưa hoàn thành đúng hạn.
...
### (4) Hệ thống Thông báo Đa kênh (In-app & Email)
- **In-app:**
    - Thông báo khi task sắp đến deadline (< 24h)
    - Thông báo khi có comment mới
    - Thông báo khi có thành viên mới tham gia project 
- **Email:**
     - Có thành viên mới join project.
     - Được giao task mới
     - Cảnh báo khi task sắp đến hạn (< 24h) hoặc đã quá hạn.
     - Gửi mã token tham gia dự án quá email
### (5) Comment & tương tác
